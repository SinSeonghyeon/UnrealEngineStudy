...
#include "Character/NGAnimInstance.h"
...
ANetworkGameStudyCharacter::ANetworkGameStudyCharacter()
{
...
void ANetworkGameStudyCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}

void ANetworkGameStudyCharacter::PostInitializeComponents()
{
...
void ANetworkGameStudyCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ANetworkGameStudyCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ANetworkGameStudyCharacter::Look);

		// Attack
		EnhancedInputComponent->BindAction(AttackAction, ETriggerEvent::Triggered, this, &ANetworkGameStudyCharacter::Attack);
	}
	else
	{
...
void ANetworkGameStudyCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANetworkGameStudyCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANetworkGameStudyCharacter::Attack(const FInputActionValue& Value)
{
	if (bCanAttack)
	{
		bCanAttack = false;
		...
		GetWorldTimerManager().SetTimer(AttackTimerHandle, this, &ANetworkGameStudyCharacter::ResetAttack, AttackTime, false);
...
void ANetworkGameStudyCharacter::ResetAttack()
{
	bCanAttack = true;
}
